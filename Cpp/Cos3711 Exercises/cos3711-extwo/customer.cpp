...
Customer::Customer(QString t, QString n, QStringList a, QString pc, QString c, double bal)
    : m_title(t), m_name(n), m_address(a), m_postCode(pc), m_code(c), m_balance(bal)
{
}
